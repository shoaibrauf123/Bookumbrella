                        ...
                        <form action="<?php echo base_url('admin/products/add'); ?>" id="create_product" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-8 padding0">
                                <div class="form-group col-md-4 margin0">
                                    ...
                                    <input type="text" class="form-control" name="buy_price" id="buy_price" value="<?php echo set_value('buy_price'); ?>" onkeypress="return isDecimalValue(event)" required/>
                                    <span class="error_signup"><?php echo form_error('buy_price'); ?></span>
                                </div>

                                <div class="form-group col-md-4 margin0">
                                    <label for="retail_price">Rent Price</label>
                                    <input type="text" class="form-control" name="rent_price" id="rent_price" value="<?php echo set_value('rent_price'); ?>" onkeypress="return isDecimalValue(event)" />
                            ...
                            <div class="form-group col-md-8 padding0">
                                <div class="form-group col-md-12 margin0">
                                    ...
                                    <input type="text" class="form-control" name="sku" id="sku" value="<?php echo set_value('sku'); ?>" required/>
                                    <span class="error_signup"><?php echo form_error('sku'); ?></span>
                                </div>

<!--                                <div class="form-group col-md-8 margin0">-->
<!--                                    <label for="retail_price">Buy Url *</label>-->
<!--                                    <input type="text" class="form-control" name="buy_url" id="buy_url" value="--><?php //echo set_value('buy_url'); ?><!--" required/>-->
<!--                                    <span class="error_signup">--><?php //echo form_error('buy_url'); ?><!--</span>-->
<!--                                </div>-->
                            </div>
...
<div class="form-group col-md-8 padding0">
                            ...
                            <div class="form-group col-md-8 padding0">
                                <div class="form-group col-md-4 margin0">
                                    ...
                                    <input type="text" class="form-control" name="edition" id="edition" value="<?php echo set_value('edition'); ?>" onkeypress="return isDecimalValue(event)" required/>
                                    <span class="error_signup"><?php echo form_error('edition'); ?></span>
                                </div>

                                <div class="form-group col-md-4 margin0">
                                    <label for="language">Language</label>
                                    <input type="text" readonly class="form-control" name="language" id="language" value="<?php echo set_value('language'); ?>" required/>
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <textarea class="form-control"  name="description" id="single-page-editor" rows="10" placeholder="Type your product long description here..." required><?php echo set_value('description'); ?></textarea>
