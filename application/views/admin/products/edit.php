                        ...
                        <form action="<?php echo base_url('admin/products/edit').'/'.$this->uri->segment(4).'/'.encode_url($product_data['product_id']); ?>" id="edit_product" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-8 padding0">
                                <div class="form-group col-md-4 margin0">
                                    <label for="buy_price">List Price </label>
                                    <input type="text" class="form-control" name="buy_price" id="buy_price" value="<?php echo $product_data['buy_price']; ?>" onkeypress="return isDecimalValue(event)" />
                                ...
                                <div class="form-group col-md-4 margin0">
                                    ...
                                    <input type="text" class="form-control" name="isbn13" id="isbn13" value="<?php echo $product_data['isbn13']; ?>" onkeypress="return isDecimalValue(event)"  required/>
                            ...
                            <div class="form-group col-md-8 padding0">
                                <div class="form-group col-md-12 margin0">
                                    ...
                                    <input type="text" class="form-control" name="sku" id="sku" value="<?php echo $product_data['sku']; ?>" />
                                 ...
                                 <div class="form-group col-md-12 margin0">
                                    <label for="grade">Month Of The Book</label>
                                       <select name="month_of_the_book" class="form-control" id="month_of_the_book">
                                            <option value="1" <?php echo  ($product_data["month_of_the_book"] == 1)? "selected" : ""?>>yes</option>
                                            <option value="0" <?php echo  ($product_data["month_of_the_book"] == 0) ? "selected" : ""?> >no</option>
                                       </select>
...
<div class="form-group col-md-8 padding0">
                                <div class="form-group col-md-6 margin0">
                                    <label for="pages">Pages</label>
                                     ...
                                     <input type="text" class="form-control" name="pages" id="pages" value="<?php echo $product_data['pages']; ?>" />
           ...
           <input type="text" class="form-control" name="weight" id="weight" value="<?php echo $product_data['weight']; ?>" />                          
...
<div class="form-group col-md-8 padding0">
                                <div class="form-group col-md-6 margin0">
                                    ...
                                    <input type="text" class="form-control" name="dimensions" id="dimensions" value="<?php echo $product_data['dimensions']; ?>" />
                                ...
                                <div class="form-group col-md-6 margin0">
                                    ...
                                    <select name="author" id="author" class="form-control">
                                        <?php if(isset($author)){foreach($author as $aut){ ?>
                                            <option value="<?php echo $aut->id ?>" <?php echo ($product_data["author"] == $aut->id) ? "selected" : "" ?>><?php echo $aut->author_name ?></option>
                                        <?php }} ?>
                                    </select>
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <textarea class="form-control"  name="description" id="single-page-editor" rows="10" placeholder="Type your product long description here..." ><?php echo $product_data['description']; ?></textarea>
