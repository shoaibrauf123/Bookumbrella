                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url('admin/users/add'); ?>" id="create_user" role="form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-8">
                                ...
                                <select class="form-control" name="role_id" id="role_id" onchange="show_business_field(this)" required>
                            ...
                            <div id="businessname_div" class="form-group col-md-8" <?php echo (set_value('role_id') == 2)? 'style="display:block;"' : 'style="display:none;"'; ?> >
                                <label for="name">Business Name *</label>
                                <input type="text" value="<?php echo set_value('username') ?>" class="form-control" placeholder="Business name" id="businessname" name="businessname" required>
