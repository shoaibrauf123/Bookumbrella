...
<div class="col-xs-12">
    <div class="container frontend-dashboard-cont">
        <div class="row no-padding">
            <div class="col-sm-12 col-xs-12">
               ...
               <div class=" detailfilter" >
                            ...
                            <input type="hidden" value="my_orders" id="current_view">
                            </form>
                            ...
                            <div class="row">
                                <div class="col-lg-12 co-md-12 col-sm-12">	
                                    <div class="order_table">
                                        <h2><a href="javascript:void(0)" class="toggle_orders active_btn" id="my_orders">My Orders</a> | <a href="javascript:void(0)" class="toggle_orders"  id="received_orders">Received Orders</a></h2>
          ...
          <div class="col-xs-12 col-sm-5">
			<div>
                ...
                <strong> ISBN-10:</strong><span><?php echo $product[0]['isbn']?></span><strong> ISBN-13:</strong><span><?php echo $product[0]['isbn13']?></span><strong> SKU:</strong><span><?php echo $row['sku']?></span> <br>
        ...
        <div class="col-xs-12 col-sm-2" style="border-left: 1px solid #ddd;">
            <div class="rateit bigstars addrating"
...
<script type="application/javascript">
  $(document).ready(function(){
    ...
    $('.toggle_orders').click(function(){
        ...
        $('#current_view').val(cls);
    })
    
    if('<?php echo ($this->input->get('view'));?>' == 'received_orders'){
        $('.toggle_orders').click();
    }
    ...
    function filter_orders(obj){
        ...
        if($('#current_view').val() != ''){
            query_str += '&view='+$('#current_view').val();
        }
        if(query_str!=''){
