<div class="container">
            ...
            <div class="main-header" itemprop="name"><?php echo $actual_product['title']; ?>, <?php echo $actual_product['edition']; ?>:<?php echo $actual_product['format']; ?></div>
            <div class="row">
			...
			<span  style="font-size:14px;  line-hight:20px; "> <p> asasas      zzzzzzzzzzzzzzzv  </p> 
			<p> asasas      zzzzzzzzzzzzzzzv  </p>
                    ...
                    <div class="product-detail-page">
                       ...
                       <ul class="nav nav-tabs" role="tablist">
                         <li role="presentation" class="active">
                           <a href="#home" aria-controls="home" role="tab" data-toggle="tab">
                            Rental $<?php echo $actual_product['rent_price'] ?>
                       ...
                       <div class="tab-content">
                         ...
                         <div class="detail-page-add-cart">
                           <p>$<?php echo $actual_product['buy_price'] ?><br>
                        ...
                        <div class="tab-pane active in" id="home">
                            ...
                            <table width="100%"  class="PDP_itemList table-responsive table-hover" cellspacing="10" cellpadding="10">
                                ...
                                <tr class="tr-border" bgcolor="#FFFFFF">
                                    ...
                                    <td>
                                    <strong>Seller:</strong> <?php echo $seller_details['username'];?>
                                    

                                    <strong>Email:</strong> <?php echo $seller_details['email'];?>
