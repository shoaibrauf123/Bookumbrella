...
<div class="well-overflow">
              ...
              $seller_store_detail = $this->comman_model->getStore("store",$row["user_id"]);
                /*echo "<pre>";
                print_r($seller_store_detail);
                die;*/
                                ...
                                <tr class="tr-border" bg-color="#FFFFFF">
                                  <td nowrap>
                                    ...
                                    <!-- <strong>Seller:</strong> -->
                                     ...
                                     <span style="font-size:16px;  font-family:Open Sans;#bb9870!important; font-weight:700;color:#008000"><?php echo ucfirst($seller_store_detail[0]["name"]);?></span>
                                     <br>
                                     ...
                                     <label style=" color:#000 !important;"><b>Comments:</b></label><p style="display:inline;color:#000 !important;"> <?php echo $row['comments'];?> </p>
