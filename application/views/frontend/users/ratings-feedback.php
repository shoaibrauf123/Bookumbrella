...
<div class="col-xs-12">
    <div class="frontend-dashboard-cont">
        <div class="row no-padding">
            ...
            if($this->session->userdata('user_type')=='Seller' || $this->session->userdata('user_type')=='seller' || $this->session->userdata('user_type')=='Seller' || $this->session->userdata('user_type')=='buyer'){
			?>
