        ...
        <li class="has-children">
            ...
            <label class="section-title">Condition</label>
                ...
                <ul class="scroll innoCustomScrollBar mCustomScrollbar _mCS_1 mCS_no_scrollbar"><div id="mCSB_1" class="mCustomScrollBox mCS-inset-dark mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                    <li><span><input onclick="filter_condition(this)" type="checkbox" class="f_condition" value="New" id="New">
                            <span>New</span>
                            </span></li>
                    <!-- <li><a href="javascript:void(0)" onclick="filter_condition('Used')"><input type="checkbox"  /><span > </span> </a></li> -->
                    <li>
                        <span><input onclick="filter_condition(this)" class="f_condition" type="checkbox" id="Used" value="Used"><span style="padding-left:3px;">Used</span></span>
                        <ul class="level-2" style="display:block;">
                            <li><span><input type="checkbox" onclick="filter_condition(this)" class="f_condition" id="Like New" value="Like New"><span>Like New</span> </span></li>
                            <li><span><input onclick="filter_condition(this)" type="checkbox" class="f_condition" id="Very Good" value="Very Good"><span>Very Good</span> </span></li>
                            <li><span><input type="checkbox" onclick="filter_condition(this)" class="f_condition" id="Good" value="Good"><span>Good</span> </span></li>
                            <li><span><input onclick="filter_condition(this)" type="checkbox" class="f_condition" value="Acceptable"><span>Acceptable</span> </span></li>
                        </ul>
                    </li>
        ...
        <li class="has-children">
            ...
            <label class="section-title">Type</label>
                <ul class="scroll innoCustomScrollBar mCustomScrollbar _mCS_2 mCS_no_scrollbar"><div id="mCSB_2" class="mCustomScrollBox mCS-inset-dark mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                    <li><span><input onclick="filter_type(this)" class="f_type" value="Normal" type="checkbox"><span> Normal </span></span></li>
                    <li><span><input onclick="filter_type(this)" class="f_type" value="Internation Edition" type="checkbox"><span> Internation Edition</span> </span></li>
                    <li><span><input onclick="filter_type(this)" class="f_type" value="Teachers Edition" type="checkbox"><span> Teachers Edition</span> </span></li>
                    <li><span><input onclick="filter_type(this)" class="f_type" value="Study Guide" type="checkbox"><span> Study Guide</span> </span></li>
                    <li><span><input onclick="filter_type(this)" class="f_type" value="Work Book" type="checkbox"><span> Work Book</span> </span></li>
                    <li><span><input onclick="filter_type(this)" class="f_type" value="Library Copy" type="checkbox"><span> Library Copy</span> </span></li>    
            ...
            <input class="menu-label" type="checkbox" checked="checked" id="f-country">
                ...
                <ul class="scroll innoCustomScrollBar mCustomScrollbar _mCS_3 mCS_no_scrollbar"><div id="mCSB_3" class="mCustomScrollBox mCS-inset-dark mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><div id="mCSB_3_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
                    <li><span> <input onclick="filter_rating(this)" class="f_rating" value="1" type="checkbox"><span class="rateit_filter rateit" data-rateit-value="1"><button id="rateit-reset-2" type="button" data-role="none" class="rateit-reset" aria-label="reset rating" aria-controls="rateit-range-2" style="display: none;"></button><span id="rateit-range-2" class="rateit-range" tabindex="0" role="slider" aria-label="rating" aria-owns="rateit-reset-2" aria-valuemin="0" aria-valuemax="5" aria-valuenow="1" aria-readonly="true" style="width: 80px; height: 16px;width: 80px;height: 16px;display: initial;"><span class="rateit-selected" style="height: 16px; width: 16px;"></span><span class="rateit-hover" style="height:16px"></span></span></span> </span></li>
                    <li><span> <input onclick="filter_rating(this)" class="f_rating" value="2" type="checkbox"><span class="rateit_filter rateit" data-rateit-value="2"><button id="rateit-reset-3" type="button" data-role="none" class="rateit-reset" aria-label="reset rating" aria-controls="rateit-range-3" style="display: none;"></button><span id="rateit-range-3" class="rateit-range" tabindex="0" role="slider" aria-label="rating" aria-owns="rateit-reset-3" aria-valuemin="0" aria-valuemax="5" aria-valuenow="2" aria-readonly="true" style="width: 80px; height: 16px;width: 80px;height: 16px;display: initial;"><span class="rateit-selected" style="height: 16px; width: 32px;"></span><span class="rateit-hover" style="height:16px"></span></span></span> </span></li>
                    <li><span> <input onclick="filter_rating(this)" class="f_rating" value="3" type="checkbox"><span class="rateit_filter rateit" data-rateit-value="3"><button id="rateit-reset-4" type="button" data-role="none" class="rateit-reset" aria-label="reset rating" aria-controls="rateit-range-4" style="display: none;"></button><span id="rateit-range-4" class="rateit-range" tabindex="0" role="slider" aria-label="rating" aria-owns="rateit-reset-4" aria-valuemin="0" aria-valuemax="5" aria-valuenow="3" aria-readonly="true" style="width: 80px; height: 16px;width: 80px;height: 16px;display: initial;"><span class="rateit-selected" style="height: 16px; width: 48px;"></span><span class="rateit-hover" style="height:16px"></span></span></span> </span></li>
                    <li><span> <input onclick="filter_rating(this)" class="f_rating" value="4" type="checkbox"><span class="rateit_filter rateit" data-rateit-value="4"><button id="rateit-reset-5" type="button" data-role="none" class="rateit-reset" aria-label="reset rating" aria-controls="rateit-range-5" style="display: none;"></button><span id="rateit-range-5" class="rateit-range" tabindex="0" role="slider" aria-label="rating" aria-owns="rateit-reset-5" aria-valuemin="0" aria-valuemax="5" aria-valuenow="4" aria-readonly="true" style="width: 80px; height: 16px;width: 80px;height: 16px;display: initial;"><span class="rateit-selected" style="height: 16px; width: 64px;"></span><span class="rateit-hover" style="height:16px"></span></span></span> </span></li>
                    <li><span> <input onclick="filter_rating(this)" class="f_rating" value="5" type="checkbox"><span class="rateit_filter rateit" data-rateit-value="5"><button id="rateit-reset-6" type="button" data-role="none" class="rateit-reset" aria-label="reset rating" aria-controls="rateit-range-6" style="display: none;"></button><span id="rateit-range-6" class="rateit-range" tabindex="0" role="slider" aria-label="rating" aria-owns="rateit-reset-6" aria-valuemin="0" aria-valuemax="5" aria-valuenow="5" aria-readonly="true" style="width: 80px; height: 16px;width: 80px;height: 16px;display: initial;"><span class="rateit-selected" style="height: 16px; width: 80px;"></span><span class="rateit-hover" style="height:16px"></span></span></span> </span></li>     
                </div><div id="mCSB_3_scrollbar_vertical" class="mCSB_scrollTools mCSB_3_scrollbar mCS-inset-dark mCSB_scrollTools_vertical" style="display: none;"><div class="mCSB_draggerContainer"><div id="mCSB_3_dragger_vertical" class="mCSB_dragger" style="position: absolute; min-height: 30px; height: 0px; top: 0px;" oncontextmenu="return false;"><div class="mCSB_dragger_bar" style="line-height: 30px;"></div></div><div class="mCSB_draggerRail"></div></div></div></div></ul>
    ...
    $(function () {
        ...
        $('.rateit_filter').rateit({
          ...
          <div class="image col-sm-2">
            ...
            <img class="" style="width:125px; height:190px;" alt="product" src="<?php echo base_url().$actual_product['image'];?>"> </div>
            </a>
          <div class="col-xs-12 col-sm-6">
			<div>
            <h4 style="margin-bottom:0px; margin-top:7px; font-size:21px;"><?php echo $product['title']?></h4>
            <strong style="color:#000 ;font-size:18px;"> Author:</strong><span style="color: rgb(187, 152, 112) !important;font-size:18px;"><?php echo $product['author']?></span></span> <br>
...
if($min_used_price[0]['price'] && $min_used_price[0]['price']>0) {
        ...
        <div class="callout corner4">
          ...
          <div class="callout-inner">
            ...
            <button
              class="btn btn-main add-cart"
              id="btn-main-add-to-cart"
            >
              Add to Cart
            </button>
            <div class="ship-flag">
