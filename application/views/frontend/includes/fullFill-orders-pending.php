...
<div class="col-xs-12">
    <div class="container frontend-dashboard-cont  ">
        <div class="row no-padding">
                            ...
                            <div class="row">
                                <div class="col-lg-12 co-md-12 col-sm-12" style="padding:0;">	
                                    <div class="order_table">
                                        <h2><a href="javascript:void(0)" class="toggle_orders active_btn" id="my_orders">Fulfill Pending Orders(<?=$total_my_orders?>)</a> 
          ...
          <div class="image col-sm-2">
            ...
            <img class="img-responsive" alt="product" style="width:100%" src="<?php echo base_url()?><?php echo $product[0]['image']?>"> </a></div>
            
            
          <div class="col-xs-12 col-sm-5 detailarea">
			<div>
 ...
 <a href="javascript:;" id="<?php echo $row['id']?>" onClick="ShowContactBuyerModal_<?php echo $row['id']?>(<?php echo $row['id']?>)"  >Contact Buyer</a> | <a href="javascript:;" onClick="ShowAddressDetailModal_<?php echo $row['id']?>(<?php echo $row['id']?>)">Click to view Shipping Address</a>
      ...
      <div class="product-filter product_mobile" style="border:0 none;">
        ...
        <div class="col-xs-12 col-sm-5 detailarearight" style="border-left: 1px solid #ddd;">
            <div>
                ...
                <strong> Order Status: </strong><span><?php echo $row['order_status']; ?></span>
...
<?php if(($row['order_status']=='Paid' || $row['order_status']=='Received') && $row['tracking_id']==''){ ?>
                ...
                <input class="form-control" type="text" value="<?php echo $row['tracking_id']; ?>" placeholder="Tracking Id" style="width:95px; float:left; margin-right:5px;" size="10" id="tracking_id_<?php echo $row['id']; ?>" name="tracking_id_<?php echo $row['id']; ?>" >
