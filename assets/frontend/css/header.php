        ...
        <div class="header-mobile-flex">
            <div class="no-padding">
                <div class="col-sm-2 col-xs-12 pull-left social logo">
                    <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>assets/frontend/img/logo.png" style="margin-left:0px; width:192px; margin-top:-5px;" 
                                                             alt=""></a>
                </div>

                <div class="col-sm-8 col-xs-10  no-padding header-input">
                    <div class="col-md-12">
                <div class="link_sign">
                <?php if(!$this->session->userdata('logged_in')){ ?>
                    <a href="<?= base_url('registration'); ?>">Sign Up</a> &nbsp;| <a href="<?= base_url('login'); ?>">Sign In</a>
                <?php } else {?>    
...
<!--                                       value="--><?php //echo ($this->input->get('isbn')) ? $this->input->get('isbn') : ''; ?><!--"/>-->
                        ...
                        <div class="row">
                            <div class="col-md-12 col-toogle">
        ...
        <div class="toggle-btn" style="">
            ...
            <div class="collapse navbar-collapse no-padding  col-sm-offset-2" id="bs-slide-dropdown">
