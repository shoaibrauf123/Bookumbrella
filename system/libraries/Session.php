...
class CI_Session {
    ...
    public $user_id = null; // by default user is guest 
    ...
    public function sess_write() {
        ...
        $this->CI->db->update($this->sess_table_name, array('last_activity' => $this->userdata['last_activity'], 'user_data' => $custom_userdata, 'user_id' => $this->user_id));
    ...
    public function sess_update() {
        ...
        if ($this->sess_use_database === TRUE) {
            ...
            $this->CI->db->query($this->CI->db->update_string($this->sess_table_name, array('last_activity' => $this->now, 'session_id' => $new_sessid, 'user_id' => $this->user_id), array('session_id' => $old_sessid)));
        }
